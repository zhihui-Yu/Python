...
class GameRound:
    def __init__(self, p1, p2):
        ...
        print("Current points is {points}".format(points=self.awardPoints(p1,p2)))
    def compareChoices(self, p1, p2):
        return self.rules[p1.toNumericalChoice()][p2.toNumericalChoice()]
    def awardPoints(self, p1, p2):
        return "{point}({name}) VS {point2}({name2})".format(point=p1.points,name=p1.name,point2=p2.points,name2=p2.name)
